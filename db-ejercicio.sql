...
/****** Object:  Database [ejercicio]    Script Date: 11/02/2022 01:03:18 p. m. ******/
CREATE DATABASE [ejercicio]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'ejercicio', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL14.MSSQLSERVER\MSSQL\DATA\ejercicio.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'ejercicio_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL14.MSSQLSERVER\MSSQL\DATA\ejercicio_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
GO
...
ALTER DATABASE [ejercicio] SET RECOVERY FULL 
GO
